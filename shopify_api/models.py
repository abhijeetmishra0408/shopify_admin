...
class Products(models.Model):
    shopify_product_id = models.DecimalField(max_digits=16, decimal_places=0, unique=True)
...
class ProductsVariant(models.Model):
    ...
    shopify_Variant_id = models.DecimalField(max_digits=18, decimal_places=0, unique=True)
